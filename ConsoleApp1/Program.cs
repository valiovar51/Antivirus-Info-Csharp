...
public class Program
{
    ...
    {
        // Представляет совокупность всех брандмауэров для этого компьютера.
        WSC_SECURITY_PROVIDER_FIREWALL = 0x1,
        // Представляет параметры автоматического обновления для этого компьютера.
        WSC_SECURITY_PROVIDER_AUTOUPDATE_SETTINGS = 0x2,
        // Представляет совокупность всех антивирусных продуктов для данного компьютера.
        WSC_SECURITY_PROVIDER_ANTIVIRUS = 0x4,
        // Представляет совокупность всех антишпионских продуктов для данного компьютера.
        WSC_SECURITY_PROVIDER_ANTISPYWARE = 0x8,
        // Представляет параметры, ограничивающие доступ к веб-сайтам в каждой из интернет-зон.
        WSC_SECURITY_PROVIDER_INTERNET_SETTINGS = 0x10,
        // Представляет параметры контроля учетных записей пользователей на этом компьютере.
        WSC_SECURITY_PROVIDER_USER_ACCOUNT_CONTROL = 0x20,
        // Представляет текущее состояние службы центра безопасности на этом компьютере.
        WSC_SECURITY_PROVIDER_SERVICE = 0x40,

        WSC_SECURITY_PROVIDER_NONE = 0,

        // Объединяет все элементы, отслеживаемые центром безопасности.
